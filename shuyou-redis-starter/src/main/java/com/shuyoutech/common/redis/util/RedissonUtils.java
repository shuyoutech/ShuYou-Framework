...
public class RedissonUtils {
    ...
    public static <T> void publish(String channelKey, T msg, Consumer<T> consumer) {
        RTopic topic = REDISSON_CLIENT.getTopic(channelKey);
        topic.publish(msg);
        consumer.accept(msg);
    }
     ...
     */
    public static <T> void subscribe(String channelKey, Class<T> clazz, MessageListener<T> messageListener) {
        RTopic topic = REDISSON_CLIENT.getTopic(channelKey);
        topic.addListener(clazz, messageListener);
    }
     ...
     * @param messageListener 监听逻辑
     */
    public static <T> void subscribe(String channelKey, Class<T> clazz, PatternMessageListener<T> messageListener) {
        RPatternTopic topic = REDISSON_CLIENT.getPatternTopic(channelKey);
        topic.addListener(clazz, messageListener);
    }
    ...
    public static <T> void addObjectListener(final String key, final ObjectListener listener) {
        RBucket<T> result = REDISSON_CLIENT.getBucket(key);
    ...
    public static boolean expire(final String key, final Duration duration) {
        return REDISSON_CLIENT.getBucket(key).expire(duration);
    }
    ...
    public static <T> boolean setCacheList(final String key, final List<T> dataList) {
        RList<T> rList = REDISSON_CLIENT.getList(key);
    ...
    public static <T> boolean setCacheSet(final String key, final Set<T> dataSet) {
        RSet<T> rSet = REDISSON_CLIENT.getSet(key);
    ...
    public static <T> void setCacheMap(final String key, final Map<String, T> dataMap) {
        if (dataMap != null) {
            RMap<String, T> rMap = REDISSON_CLIENT.getMap(key);
            rMap.putAll(dataMap);
        }
    }
    ...
    public static <K, V> Map<K, V> getMultiCacheMapValue(final String key, final Set<K> hKeys) {
        RMap<K, V> rMap = REDISSON_CLIENT.getMap(key);
    ...
    public static void setAtomicValue(String key, long value) {
        RAtomicLong atomic = REDISSON_CLIENT.getAtomicLong(key);
        atomic.set(value);
    }
    ...
    public static void deleteKeys(final String pattern) {
        REDISSON_CLIENT.getKeys().deleteByPattern(pattern);
    }
     ...
     * 分布式锁
     */
    public static <V> V lock(String key, Long timeoutMillis, Callable<V> callable) {
        String lockKey = String.format(PAY_WALLET_LOCK, key);
